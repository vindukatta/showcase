...
public class ApplicationAcceptenceAPITest_Success_201 extends APITestInitialise {
    ...
    public void acceptanceAPI(HashMap<String, String> dataSet){
        ...
        ExtentTestManager.getTest().log(Status.INFO, "Company : ["+dataSet.get("LegalName")+"]");
        ...
        ExtentTestManager.getTest().log(Status.INFO,"Expected Response : [201], Actual Response:["+response+"] " );
