...
import pageObjects.Onboarding.TransactionDetails;
...
public class OnBoardNewUserJourney extends TestInitialise {
    ...
    public void OnBoardNewUserJourney(HashMap<String, String> dataSet) {
